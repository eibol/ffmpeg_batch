...
| Hardcode (burn) subtitles and resize video, using vf filter and external srt file -> h264/aac (replace size srt file path with your own settings | | -map 0 -c:v libx264 -crf 23 -vf "scale=640:360,subtitles=C\\:/Users/\Data/\Videos/\input_file.srt" -c:a aac -b:a 128K | mkv |
