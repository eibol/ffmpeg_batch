...
| Trailer from input video, 1 second sequence every 13 seconds, total lengt 13 seconds) | | -vf select='lt(mod(t,13),1)',setpts=N/FRAME_RATE/TB -af aselect='lt(mod(t,13),1)',asetpts=N/SR/TB -c:v libx264 -preset fast -crf 23 -c:a aac -ab 128K -t 13 | mp4 |
| Trailer from input video, 1 second sequence every 13 seconds, using first 13 seconds fragments) | | -vf select='lt(mod(t,13),1)',setpts=N/FRAME_RATE/TB -af aselect='lt(mod(t,13),1)',asetpts=N/SR/TB -c:v libx264 -preset fast -crf 23 -c:a aac -ab 128K -t 13 | mp4 |
