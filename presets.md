...
| Generate keyframes report to txt file | -skip_frame nokey -an -sn -dn | -vstats_file C:\Reports\stats.txt -vf "select='eq(pict_type,PICT_TYPE_I)'" -vsync vfr -frame_pts true -f null - | nul|
