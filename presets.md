...
| Speed up video and audio by factor (100x) to mp4 h264 | | -c:v libx264 -preset fast -c:a aac -b:a 128K -filter_complex "[0:v]setpts=1/100*PTS[v];[0:a]atempo=100[a]" -map "[v]" -map "[a]" | mp4 |
