...
namespace FFBatch
{
    public partial class Form22 : Form
    {
        ...
        private OpenFileDialog of1 = new OpenFileDialog();
        ...
        private void get_dur()
        {
            ...
            if (intro == true) probe.StartInfo.Arguments = '\u0022' + "--Inform=General;%Duration/String3%" + '\u0022' + " " + '\u0022' + txt_intro.Text + '\u0022';
            else probe.StartInfo.Arguments = '\u0022' + "--Inform=General;%Duration/String3%" + '\u0022' + " " + '\u0022' + txt_end.Text + '\u0022';
            probe.Start();
